...
public class Main {
    public static void main(String[] args) {
        ...
        task2_02.Start();
        Task_02_QuadraticEquation task2_03 = new Task_02_QuadraticEquation(0, 5, 5);
        task2_03.Start();
        Task_02_QuadraticEquation task2_04 = new Task_02_QuadraticEquation(0, 0, 5);
        task2_04.Start();
        Task_02_QuadraticEquation task2_05 = new Task_02_QuadraticEquation(0, 5, 25);
        task2_05.Start();
        Task_02_QuadraticEquation task2_06 = new Task_02_QuadraticEquation(25, 0, 0);
        task2_06.Start();
        Task_02_QuadraticEquation task2_07 = new Task_02_QuadraticEquation(5, 0, 25);
        task2_07.Start();
        Task_02_QuadraticEquation task2_08 = new Task_02_QuadraticEquation(5, 0, -25);
        task2_08.Start();
